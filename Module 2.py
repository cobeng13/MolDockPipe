...
Run:  python m2_smiles_to_sdf_rdkit.py
"""
...
# ------------------------------ Manifest -------------------------------------
# If you've updated headers to 'tools_rdkit', use that; otherwise keep 'tools_obabel' empty.
MANIFEST_FIELDS = [
    "id","smiles","inchikey",
...
def main():
    ...
    print(f"✅ RDKit SMILES→SDF complete. DONE: {done}  FAILED: {failed}")
