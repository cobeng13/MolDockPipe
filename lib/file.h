...
/*定义结构体ifile    继承父类ifstream
* 定义构造函数   输入  文件路径name  如果没有输入  抛出异常
定义构造函数   输入  文件路径name    输入模式mode   如果没有输入  抛出异常
...
/*定义结构体ofile    继承父类ofstream
* 定义构造函数   输入  文件路径name  如果输入失败  抛出异常
定义构造函数   输入  文件路径name    输入模式mode   如果输入失败  抛出异常
